...
public class PostFileSummaryResponseFixture {
  ...
  public static final PostFileSummaryResponse DEFAULT_POST_FILE_SUMMARIES = PostFileSummaryResponse.builder()
      .images(List.of(
          new PostFileSummary(0, "post/0197a143-7979-7d70-a2e3-8d51a56fc86a.png"),
          new PostFileSummary(1, "post/0197a143-7979-7df1-825a-1c20433fd532.jpg"),
          new PostFileSummary(2, "post/0197a143-7979-7f02-9572-2f066b3c1796.gif")
      ))
      .build();
