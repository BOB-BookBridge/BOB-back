...
public class CreatePostCommandFixture {
  ...
  public static CreatePostCommand defaultCreatePostCommand() {
    return CreatePostCommand.builder()
        ...
        .imageReferenceId(UUID.randomUUID().toString())
        .build();
  }

  public static CreatePostCommand createPostCommandWithImageRefId(String refId) {
    return CreatePostCommand.builder()
        .memberId(MEMBER_ID)
        .categoryId(1)
        .sellPrice(38000)
  ...
  public static CreatePostCommand defaultCreatePostCommand(UUID memberId, Integer categoryId, String refId) {
    return CreatePostCommand.builder()
        .memberId(memberId)
