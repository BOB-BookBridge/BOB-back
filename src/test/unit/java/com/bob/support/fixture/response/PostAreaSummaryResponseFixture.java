...
public class PostAreaSummaryResponseFixture {
  ...
  public static final PostAreaSummaryResponse DEFAULT_AREA_SUMMARY = PostAreaSummaryResponse.builder()
      .emdId(EMD_AREA_ID)
      .emdName("역삼동")
      .siggName("강남구")
      .validity(true)
  ...
  public static final PostAreaSummaryResponse NOT_VALID_AREA_SUMMARY = PostAreaSummaryResponse.builder()
      .emdId(EMD_AREA_ID)
      .emdName("역삼동")
      .siggName("강남구")
      .validity(false)
