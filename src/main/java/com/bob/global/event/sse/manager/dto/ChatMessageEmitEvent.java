...
public record ChatMessageEmitEvent(
    ...
    public static ChatMessageEmitEvent of(boolean isSystem, String id, String content, List<String> fileNames,
        LocalDateTime sentAt) {
        Long messageId = parseMessageIdOrNull(id);
        return new ChatMessageEmitEvent(messageId, resolveMessageType(isSystem, id, content, fileNames), content,
            withSequence(fileNames), sentAt);
    }
